...
public class blue_slime_script : MonoBehaviour
{
    ...
    void Start()
    {
        rabbitAnimator = GameObject.Find("blue_slime").GetComponent<Animator>();
    ...
    void Update()
    {
        ...
        // Start reviving
        if (health < 0) {
            rabbitAnimator.SetFloat("slime_is_die", 2f);
    ...
    IEnumerator Revive(){
        ...
        health = maxHealth;
        rabbitAnimator.SetFloat("slime_is_die", 0f);
        isReviving = false;
    }
